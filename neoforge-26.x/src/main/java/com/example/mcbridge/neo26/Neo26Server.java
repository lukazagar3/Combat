package com.example.mcbridge.neo26;
...
public class Neo26Server implements IServer {
    private final MinecraftServer server;

    public Neo26Server(MinecraftServer server) {
        this.server = server;
    }
    ...
    public IPlayer getPlayer(UUID uuid) {
        ...
        return player == null ? null : new Neo26Player(player);
    }
